...
class ItemValidationTest(FunctionalTest):		
	...
	def test_cannot_add_empty_list_item(self):
		...
		self.browser.find_element_by_id('new_todo_item').send_keys('\n')
		...
		self.browser.find_element_by_id('new_todo_item').send_keys('Buy cookies for milk\n')
		...
		self.browser.find_element_by_id('new_todo_item').send_keys('Pre-heat milk for 1.5 minutes\n')
		self.list_item_in_list('1: Buy cookies for milk')
